<template>
  <div v-if="isLayout" :class="getLayout">
    <div
      ...
      :key="i"
      :class="COLSPAN_READ_ONLY[(child as any).options?.colspan ?? 12]"
    >
...
import { COLSPAN_READ_ONLY } from './colspan';

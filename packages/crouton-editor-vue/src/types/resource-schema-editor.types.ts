/**
 * Shared types/constants between the resource JSON editor components.
 *
 * Moved from `crouton-vue` — these are now owned by the standalone
 * `crouton-editor-vue` package so the dumb component has zero dependency
 * on the host app.
 */

...
import { buildSubResourceOperations, resolveActions } from './payload-builders'; // ── Sub-resource handlers ─────────────────────────────────────────────────
...
const registerSubResourceFindAll = (
  ctx: OperationContext,
  sub: SubResourceConfig,
): void => {
  ...
  def(
    cls,
    methodName,
    async function (this: { repo: CrudRepository }, id: string, params: any) {
  ...
  ApiOperation({ summary: `List ${sub.childRoute} for a ${name}` })(
    cls.prototype,
    methodName,
    d,
  );
  ApiParam(idParamMeta)(cls.prototype, methodName, d);
  ApiResponse({ status: 200, description: `${sub.childRoute} list` })(
    cls.prototype,
    methodName,
    d,
  );
...
const registerSubResourceFindOne = (
  ctx: OperationContext,
  sub: SubResourceConfig,
): void => {
  ...
  ApiOperation({ summary: `Get a ${sub.childRoute} record` })(
    cls.prototype,
    methodName,
    d,
  );
  ApiParam(ctx.idParamMeta)(cls.prototype, methodName, d);
  ApiResponse({ status: 200, description: `${sub.childRoute} record` })(
    cls.prototype,
    methodName,
    d,
  );
...
const registerSubResourceUpdate = (
  ctx: OperationContext,
  sub: SubResourceConfig,
): void => {
  ...
  ApiOperation({ summary: `Replace a ${sub.childRoute} record` })(
    cls.prototype,
    methodName,
    d,
  );
  ApiParam(ctx.idParamMeta)(cls.prototype, methodName, d);
  ApiResponse({ status: 200, description: `${sub.childRoute} replaced` })(
    cls.prototype,
    methodName,
    d,
  );
...
const registerSubResourcePatch = (
  ctx: OperationContext,
  sub: SubResourceConfig,
): void => {
  ...
  Param('childId')(cls.prototype, methodName, 1);
  Body()(cls.prototype, methodName, 2);
  ApiOperation({ summary: `Update a ${sub.childRoute} record` })(
    cls.prototype,
    methodName,
    d,
  );
  ApiParam(ctx.idParamMeta)(cls.prototype, methodName, d);
  ApiResponse({ status: 200, description: `${sub.childRoute} updated` })(
    cls.prototype,
    methodName,
    d,
  );
...
const registerSubResourceDelete = (
  ctx: OperationContext,
  sub: SubResourceConfig,
): void => {
  ...
  Param('id')(cls.prototype, methodName, 0);
  Param('childId')(cls.prototype, methodName, 1);
  ApiOperation({ summary: `Delete ${sub.childRoute} record` })(
    cls.prototype,
    methodName,
    d,
  );
  ApiParam(ctx.idParamMeta)(cls.prototype, methodName, d);
  ApiResponse({ status: 200, description: `${sub.childRoute} deleted` })(
    cls.prototype,
    methodName,
    d,
  );

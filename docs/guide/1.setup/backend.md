...
The simplest setup loads everything from the file system — point `forResourceDir` at your resources folder and your
data-sources folder:
...
Each resource directory must contain a `schema.ts` that default-exports the Zod schema describing one record. If you
generate Zod schemas from your Prisma models, re-export the generated one:
